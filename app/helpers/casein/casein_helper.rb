module Casein
  module CaseinHelper
    ...
    def casein_get_footer_string include_version = false
      if include_version
        I18n.t("helpers.casein.footer_version", :link => link_to('Casein', 'http://www.github.com/russellquinn/casein'), :version => casein_get_full_version_string).html_safe
      else
        I18n.t("helpers.casein.footer_no_version", :link => link_to('Casein', 'http://www.github.com/russellquinn/casein')).html_safe
      end
    end
  	...
  	def casein_get_access_level_text level
        ...
        when $CASEIN_USER_ACCESS_LEVEL_ADMIN
          return I18n.t("helpers.casein.admin")
        when $CASEIN_USER_ACCESS_LEVEL_USER
  	      return I18n.t("helpers.casein.user")
  	    else
  	      return I18n.t("helpers.casein.unknown")
  	  end
  	end

  	def casein_get_access_level_array
  	  [[I18n.t("helpers.casein.admin"), $CASEIN_USER_ACCESS_LEVEL_ADMIN], [I18n.t("helpers.casein.user"), $CASEIN_USER_ACCESS_LEVEL_USER]]
  	end

    def casein_pagination_details objs
      I18n.t("helpers.casein.pagination", :current_page => objs.current_page, :total_pages => objs.total_pages).html_safe if objs.current_page && objs.total_pages > 1
    end
